...
const EXTRA_AUTO_NAME_TRANSLATIONS = {
  "Dust Devil": "먼지 악마",
  "Earth Tremor": "대지의 진동",
  "Earthbind": "대지 속박",
  "Elemental Bane": "원소 파멸",
  "Elemental Weapon": "원소 무기",
  "Enemies Abound": "사방의 적",
  "Enervation": "활력 고갈",
  "Ensnaring Strike": "속박의 강타",
  "Erupting Earth": "분출하는 대지",
  "Evard's Black Tentacles": "에바드의 검은 촉수",
  "Fast Friends": "급속 친교",
  "Feign Death": "가사 상태",
  "Fizban's Platinum Shield": "피즈반의 백금 방패",
  "Flame Arrows": "화염 화살",
  "Fount of Moonlight": "월광의 샘",
  "Frostbite": "동상",
  "Grasping Vine": "붙잡는 덩굴",
  "Gust": "돌풍",
  "Healing Spirit": "치유의 영",
  "Hex": "헥스",
  "Hunger of Hadar": "하다르의 굶주림",
  "Immolation": "소각",
  "Infernal Calling": "지옥 소환",
  "Infestation": "감염",
  "Intellect Fortress": "정신 요새",
  "Investiture of Flame": "화염의 현신",
  "Jallarzi's Storm of Radiance": "잘라지의 광휘 폭풍",
  "Jim's Magic Missile": "짐의 매직 미사일",
  "Kinetic Jaunt": "운동력 질주",
  "Leomund's Secret Chest": "레오문드의 비밀 상자",
  "Leomund's Tiny Hut": "레오문드의 작은 오두막",
  "Lightning Arrow": "번개 화살",
  "Lightning Lure": "번개 유인",
  "Maddening Darkness": "광기의 어둠",
  "Maximilian's Earthen Grasp": "막시밀리언의 흙 손아귀",
  "Melf's Minute Meteors": "멜프의 극소 유성",
  "Mental Prison": "정신 감옥",
  "Mighty Fortress": "거대한 요새",
  "Mind Sliver": "정신 파편",
  "Mold Earth": "대지 조형",
  "Mordenkainen's Faithful Hound": "모르덴카이넨의 충실한 사냥개",
  "Mordenkainen's Private Sanctum": "모르덴카이넨의 사적 성소",
  "Motivational Speech": "고무 연설",
  "Nathair's Mischief": "나테어의 장난",
  "Negative Energy Flood": "음에너지 범람",
  "Nystul's Magic Aura": "니스툴의 마법 오라",
  "Otiluke's Freezing Sphere": "오틸루크의 빙결 구체",
  "Otto's Irresistible Dance": "오토의 저항할 수 없는 춤",
  "Phantasmal Force": "환영의 힘",
  "Power Word Pain": "권능어: 고통",
  "Primal Savagery": "원초적 야성",
  "Primordial Ward": "원초의 수호",
  "Psychic Scream": "정신의 비명",
  "Raulothim's Psychic Lance": "라울로심의 정신 창",
  "Rime's Binding Ice": "라임의 속박 얼음",
  "Shadow of Moil": "모일의 그림자",
  "Shining Smite": "빛나는 강타",
  "Snare": "올가미 덫",
  "Snilloc's Snowball Swarm": "스닐록의 눈뭉치 떼",
  "Soul Cage": "영혼 감옥",
  "Spirit Shroud": "영혼 장막",
  "Staggering Smite": "휘청이게 하는 강타",
  "Starry Wisp": "별빛 잔광",
  "Steel Wind Strike": "강철 바람 일격",
  "Storm Sphere": "폭풍 구체",
  "Summon Aberration": "변이체 소환",
  "Summon Beast": "야수 소환",
  "Summon Construct": "구조물 소환",
  "Summon Draconic Spirit": "용의 영혼 소환",
  "Summon Fey": "페이 소환",
  "Summon Fiend": "악마 소환",
  "Summon Greater Demon": "상급 악마 소환",
  "Summon Lesser Demons": "하급 악마 소환",
  "Summon Shadowspawn": "그림자 산물 소환",
  "Sword Burst": "검 폭발",
  "Tasha's Bubbling Cauldron": "타샤의 보글보글 가마솥",
  "Tasha's Caustic Brew": "타샤의 부식성 양조물",
  "Tasha's Hideous Laughter": "타샤의 흉측한 웃음",
  "Tasha's Mind Whip": "타샤의 정신 채찍",
  "Telepathy": "텔레파시",
  "Temple of the Gods": "신들의 신전",
  "Tenser's Transformation": "텐서의 변신",
  "Thorn Whip": "가시 채찍",
  "Thunder Step": "천둥 걸음",
  "Thunderous Smite": "천둥의 강타",
  "Tidal Wave": "해일",
  "Tiny Servant": "작은 하인",
  "Transmute Rock": "암석 변성",
  "Vortex Warp": "소용돌이 전이",
  "Wall of Light": "빛의 벽",
  "Whirlwind": "회오리바람",
  "Witch Bolt": "마녀의 화살",
  "Wither and Bloom": "시들음과 개화",
  "Word of Radiance": "광휘의 말씀",
  "Yolande's Regal Presence": "욜란드의 위엄",
  "Boomerang": "부메랑",
  "Caltrops": "마름쇠",
  "Camel": "낙타",
  "Carpet of Flying": "비행 양탄자",
  "Cartographer's Map Case": "지도제작사의 지도 통",
  "Cloak of Invisibility": "투명화의 망토",
  "Clothes of Mending": "수선의 옷",
  "Clothes, Fine": "고급 의복",
  "Crook of Rao": "라오의 목자의 지팡이",
  "Crossbow, Hand": "핸드 크로스보우",
  "Crossbow, Heavy": "헤비 크로스보우",
  "Crossbow, Light": "라이트 크로스보우",
  "Daern's Instant Fortress": "던의 즉석 요새",
  "Dark Shard Amulet": "암흑 파편 아뮬렛",
  "Devotee's Censer": "헌신자의 향로",
  "Elephant": "코끼리",
  "Enduring Spellbook": "지속의 주문서",
  "Energy Cell": "에너지 셀",
  "Ersatz Eye": "대용 안구",
  "Failed Experiment Wand": "실패한 실험의 완드",
  "Gray Bag of Tricks": "회색 재주의 주머니",
  "Hat of Many Spells": "다수 주문의 모자",
  "Hat of Wizardry": "마도술의 모자",
  "Heart Weaver's Primer": "심장 직조자의 입문서",
  "Hell Hound Cloak": "지옥 사냥개의 망토",
  "Heward's Handy Spice Pouch": "휴어드의 편리한 향신료 주머니",
  "Holy Water (flask)": "성수 (플라스크)",
  "Horn of Silent Alarm": "침묵의 경보 뿔피리",
  "Iggwilv's Cauldron": "이그윌브의 가마솥",
  "Illuminator's Tattoo": "조명사의 문신",
  "Instrument of Illusions": "환영의 악기",
  "Instrument of Scribing": "필사의 악기",
  "Keelboat": "킬보트",
  "Lifewell Tattoo": "생명의 샘 문신",
  "Lolth's Sting": "롤스의 독침",
  "Luba's Tarokka of Souls": "루바의 영혼 타로카",
  "Masquerade Tattoo": "가면무도회 문신",
  "Master's Amulet": "대가의 아뮬렛",
  "Mastiff": "마스티프",
  "Mighty Servant of Leuk-o": "루크오의 강대한 하인",
  "Mirror of the Past": "과거의 거울",
  "Monster Hunter's Pack": "괴물사냥꾼의 꾸러미",
  "Mule": "노새",
  "Mystery Key": "수수께끼 열쇠",
  "Nepenthe": "네펜테",
  "Niko's Mace": "니코의 메이스",
  "Oathbow Longbow": "맹세활 장궁",
  "Oathbow Shortbow": "맹세활 단궁",
  "Occultant Abacus": "오컬턴트 주판",
  "Oil": "기름",
  "Oil of Taggit": "태깃의 기름",
  "Orb of Time": "시간의 구체",
  "Orrery of the Wanderer": "방랑자의 행성의",
  "Perfume of Bewitching": "매혹의 향수",
  "Piercer": "꿰뚫개",
  "Planecaller's Codex": "차원소환사의 서전",
  "Riding Horse": "승용마",
  "Rust Bag of Tricks": "녹빛 재주의 주머니",
  "Tan Bag of Tricks": "황갈색 재주의 주머니",
  "Warhorse": "군용마",
  "Whelm": "웰름",
  "Woodcutter's Axe": "나무꾼의 도끼"
};
...
const LONGFORM_FRAGMENT_REPLACEMENTS = [
  ...
  ["Immediately after making an attack roll or a damage roll with a ranged weapon, the archer can roll a [[/r d10]] and add the number rolled to the total.", "궁수는 원거리 무기로 공격 굴림이나 피해 굴림을 한 직후 [[/r d10]]을 굴려 나온 수를 총합에 더할 수 있습니다."],
  ["The banshee can magically sense the presence of living creatures up to 5 miles away that aren't undead or constructs. She knows the general direction they're in but not their exact locations.", "밴시는 언데드나 구조물이 아닌 살아 있는 크리처의 존재를 최대 5마일 밖에서도 마법적으로 감지할 수 있습니다. 그들이 있는 대략적인 방향은 알지만 정확한 위치까지는 알지 못합니다."],
  ["A bear trap resembles a set of iron jaws that springs shut when stepped on, clamping down on a creature's leg. The trap is spiked in the ground, leaving the victim immobilized.", "곰덫은 밟는 순간 철제 턱이 튀어 오르며 닫혀 크리처의 다리를 물어 버리는 구조입니다. 덫은 땅에 단단히 고정되어 있어 희생자를 움직이지 못하게 만듭니다."],
  ["A creature that steps on the bear trap triggers it.", "곰덫을 밟은 크리처가 함정을 발동시킵니다."],
  ["A successful DC 10 Wisdom (&Reference[skill=Perception]) check reveals the trap. A successful DC 10 Dexterity check using @item[thieves' tools|phb] disables it.", "DC 10 지혜 (&Reference[skill=Perception]{지각 Perception}) 판정에 성공하면 덫을 발견합니다. @item[thieves' tools|phb]{도둑 도구}를 사용한 DC 10 민첩 판정에 성공하면 덫을 해제합니다."],
  ["The rat has gills, iridescent scales, and the ability to breathe air and water.", "이 쥐는 아가미와 무지갯빛 비늘을 지녔으며, 공기와 물속에서 모두 숨을 쉴 수 있습니다."],
  ["The crossbow trap is a favorite of kobolds and other creatures that rely on traps to defend their lairs. It consists of a trip wire strung across a hallway and connected to a pair of hidden heavy crossbows. The crossbows are aimed to fire down the hallway at anyone who disturbs the trip wire.", "석궁 함정은 코볼트와 같이 굴을 지키기 위해 함정에 의존하는 크리처들이 즐겨 쓰는 장치입니다. 복도를 가로지르는 걸림줄과 그 줄에 연결된 숨겨진 중석궁 한 쌍으로 이루어져 있으며, 줄을 건드리는 자를 향해 복도 아래로 사격하도록 조준되어 있습니다."],
  ["A creature that walks through the trip wire triggers the trap.", "걸림줄을 통과한 크리처가 함정을 발동시킵니다."],
  ["Some folk who build dungeons, such as mad wizards in search of new victims, have no intention of allowing their visitors to make an easy escape. A falling portcullis trap can be especially devious if it causes a portcullis to drop some distance away from the pressure plate that activates the trap. Although the trap is deep in the dungeon, the portcullis closes off the dungeon entrance, which is hundreds of feet away, meaning that adventurers don't know they are trapped until they decide to head for the exit.", "새 희생자를 찾는 광인 마법사 같은 일부 던전 제작자들은 침입자가 쉽게 도망치도록 내버려둘 생각이 없습니다. 낙하식 철책문 함정은 이를 발동시키는 압력판에서 한참 떨어진 곳의 철책문을 떨어뜨릴 수 있어 특히 교활합니다. 함정 자체는 던전 깊숙한 곳에 있지만, 수백 피트 떨어진 입구를 철책문이 막아 버리므로 모험가들은 출구로 돌아가려 할 때까지 자신들이 갇혔다는 사실조차 깨닫지 못할 수 있습니다."],
  ["A creature that steps on the pressure plate triggers the trap.", "압력판을 밟은 크리처가 함정을 발동시킵니다."],
  ["An iron portcullis drops from the ceiling, blocking an exit or a passageway.", "천장에서 철제 철책문이 떨어져 출구나 통로를 막아 버립니다."],
  ["Anyone who steps on the mosaic causes fire to erupt from it. Those who openly wear holy symbols of Pyremius don't trigger this trap.", "모자이크를 밟는 자는 그 자리에서 불길을 분출시킵니다. 파이레미우스의 성표를 드러내고 착용한 자는 이 함정을 발동시키지 않습니다."],
  ["The temple of Pyremius, a god of fire, is threatened by thieves who seek to steal the fire opals displayed there by the priests in tribute to their god. A mosaic on the floor of the entryway to the inner sanctum delivers a fiery rebuke to intruders.", "불의 신 파이레미우스의 신전은, 사제들이 신에게 바치는 공물로 전시한 화염 오팔을 훔치려는 도둑들의 위협을 받고 있습니다. 내전 입구 바닥의 모자이크는 침입자에게 불의 응징을 가합니다."],
  ["If destroyed, the lich reforms in [[/r 1d10]] days if it has a spirit jar, reviving with all its @variantrule[Hit Points|XPHB]. The new body appears in an unoccupied space within the lich's lair.", "리치가 영혼 단지를 가지고 있다면 파괴되더라도 [[/r 1d10]]일 뒤 다시 형체를 되찾으며, 모든 @variantrule[Hit Points|XPHB]를 회복한 상태로 부활합니다. 새 육체는 리치의 은신처 안 비어 있는 공간에 나타납니다."],
  ["The lich casts @UUID[Actor.nBe9306a8ZoEp0s5.Item.bJa62OWecWHpTuQJ] or @UUID[Actor.nBe9306a8ZoEp0s5.Item.f8j0F3xGv5utmRWL] in response to the spell's trigger, using the same spellcasting ability as Spellcasting.", "리치는 주문 발동 조건에 반응하여 @UUID[Actor.nBe9306a8ZoEp0s5.Item.bJa62OWecWHpTuQJ] 또는 @UUID[Actor.nBe9306a8ZoEp0s5.Item.f8j0F3xGv5utmRWL]을 시전하며, 이때 사용하는 주문시전 능력은 자신의 주문 시전과 동일합니다."],
  ["Goblins, with their propensity to enslave their enemies, prefer traps that leave intruders intact so the victims can be put to work in the mines or elsewhere.", "고블린은 적을 노예로 삼는 경향이 있기 때문에, 침입자를 온전한 상태로 붙잡아 광산이나 다른 곳에서 부릴 수 있게 해 주는 함정을 선호합니다."],
  ["A trip wire strung across a hallway is rigged to a large net. If the trip wire is broken, the net falls on intruders. An iron bell is also rigged to the trip wire. It rings when the trap activates, alerting nearby guards.", "복도를 가로지르는 걸림줄에는 커다란 그물이 연결되어 있습니다. 걸림줄이 끊어지면 그물이 침입자 위로 떨어집니다. 같은 줄에는 쇠종도 연결되어 있어 함정이 발동하면 울리며 근처 경비에게 경고합니다."],
  ["This trap activates as soon as a non-undead creature enters the hallway, and it remains active while any non-undead creature is within the hall.", "이 함정은 언데드가 아닌 크리처가 복도로 들어서는 즉시 활성화되며, 언데드가 아닌 크리처가 복도 안에 있는 동안 계속 작동합니다."],
  ["The blades and the rune become more dangerous the longer the trap remains active.", "함정이 오래 활성화될수록 칼날과 룬은 더욱 위험해집니다."],
  ["Blades Accelerate.", "칼날 가속."],
  ["The blades move with increasing speed, slowing only when they hit a target. Each time the blades miss with an attack, their next attack becomes harder to avoid. After each miss, the blades' attack bonus increases by 2, and their damage increases by 3 ([[/r 1d6]]). These benefits apply until the blades hit a target, after which the values return to normal.", "칼날은 점점 더 빠르게 움직이며, 목표에 명중할 때만 잠시 느려집니다. 칼날이 공격을 빗나갈 때마다 다음 공격은 더 피하기 어려워집니다. 빗나갈 때마다 칼날의 공격 보너스는 2 증가하고 피해는 3 ([[/r 1d6]]) 증가합니다. 이 증가는 칼날이 목표를 명중할 때까지 유지되며, 명중하면 수치는 정상으로 돌아갑니다."],
  ["Rune's Defense.", "룬의 방어."],
  ["Tampering with the Rune of Fear increases the trap's power. Each successful check on an attempt to disable the rune increases the damage of the blades and the crushing pillars by 5 ([[/r 1d10]]) and increases the rune's saving throw DC by 1.", "공포의 룬을 함부로 건드리면 함정의 힘이 강해집니다. 룬을 해제하려는 시도에서 판정에 한 번 성공할 때마다 칼날과 압쇄 기둥의 피해가 5 ([[/r 1d10]]) 증가하고, 룬의 내성 DC가 1 증가합니다."],
  ["The Whirling Blades and the Rune of Fear affect each creature that ends its turn in an area affected by these elements.", "소용돌이치는 칼날과 공포의 룬은 이 요소들의 영향을 받는 구역에서 턴을 마치는 모든 크리처에게 영향을 줍니다."],
  ["Whirling Blades.", "소용돌이치는 칼날."],
  ["Any creature that ends its turn in the blades' area is targeted by an attack: +5 attack bonus; 5 (1d10) slashing damage on a hit.", "칼날 구역에서 턴을 마친 모든 크리처는 공격의 대상이 됩니다: 공격 보너스 +5, 명중 시 참격 피해 5 ([[/r 1d10]])."],
  ["Rune of Fear.", "공포의 룬."],
  ["Any creature that ends its turn within 30 feet of the far end of the corridor must make a saving throw against the Rune of Fear effect.", "복도 끝에서 30피트 이내에서 턴을 마친 모든 크리처는 공포의 룬 효과에 대한 내성 굴림을 해야 합니다."]
];
...
export class TranslationStore {
  ...
  _translateGeneratedTextSegment(text) {
    ...
    let output = protectedText
      ...
      .replace(/Immediately after making an attack roll or a damage roll with a ranged weapon, the archer can roll a (__FVTT_TOKEN_\d+__) and add the number rolled to the total\./gu, (_, roll) => `궁수는 원거리 무기로 공격 굴림이나 피해 굴림을 한 직후 ${roll}을 굴려 나온 수를 결과에 더할 수 있습니다.`)
      .replace(/If destroyed, the lich reforms in (__FVTT_TOKEN_\d+__) days if it has a spirit jar, reviving with all its (__FVTT_TOKEN_\d+__)\. The new body appears in an unoccupied space within the lich's lair\./gu, (_, days, hp) => `리치가 영혼 단지를 가지고 있다면 파괴되더라도 ${days}일 후 다시 형체를 갖추며, 모든 ${hp}를 회복한 채 부활합니다. 새로운 육체는 리치의 둥지 안 비어 있는 공간에 나타납니다.`)
      .replace(/The lich casts (__FVTT_TOKEN_\d+__) or (__FVTT_TOKEN_\d+__) in response to the spell's trigger, using the same spellcasting ability as Spellcasting\./gu, (_, spellA, spellB) => `리치는 주문시전과 같은 주문시전 능력을 사용하여, 방아쇠가 충족되면 ${spellA} 또는 ${spellB}를 시전합니다.`)
      .replace(/The trap acts on initiative count 20 and initiative count 10\./gu, "이 함정은 우선권 수치 20과 10에서 행동합니다.")
      .replace(/The simplest of pit traps consists of a 10-foot-deep hole in the floor, concealed by tattered canvas that's covered with leaves and dirt to look like solid ground\. This type of trap is useful for blocking off the entrance to a monster lair, and usually has narrow ledges along its sides to allow for movement around it\./gu, "가장 단순한 구덩이 함정은 바닥에 파인 깊이 10피트의 구멍으로, 낡은 천 위를 나뭇잎과 흙으로 덮어 단단한 지면처럼 보이게 숨겨 둡니다. 이런 함정은 몬스터의 소굴 입구를 막는 데 유용하며, 보통 가장자리를 따라 좁은 발판이 있어 옆으로 돌아 지날 수 있습니다.")
      .replace(/Anyone who steps on the canvas might fall into the pit\./gu, "천 위를 밟는 자는 누구든 구덩이로 떨어질 수 있습니다.")
      .replace(/A tiny, poisoned needle hidden in a lock is a good way to discourage thieves from plundering a hoard\. Such a trap is usually put in a chest or in the door to a treasure chamber\./gu, "자물쇠 속에 숨겨진 작은 독침은 도둑이 보물을 약탈하려는 시도를 단념시키는 좋은 수단입니다. 이런 함정은 보통 상자나 보물 방의 문에 설치됩니다.")
      .replace(/Anyone attempting to pick or open the lock triggers the trap\./gu, "자물쇠를 따거나 열려고 시도하는 자는 누구든 이 함정을 발동시킵니다.")
      .replace(/This fiendish trap was built to eliminate intruders who infiltrate a yuan-ti temple\. The trap is a room, 60 feet on a side, with 5-foot-wide stone doors in the middle of each wall\. In each corner of the room stands a 10-foot-tall statue of a great serpent, coiled and ready to strike\. The eyes in each statue are rubies worth 200 gp apiece\./gu, "이 사악한 함정은 유안티 사원에 침입한 자들을 제거하기 위해 만들어졌습니다. 함정은 한 변이 60피트인 방 전체이며, 각 벽의 중앙에는 폭 5피트의 석문이 있습니다. 방의 네 모서리마다 몸을 웅크리고 공격 태세를 갖춘 높이 10피트의 거대한 뱀 석상이 서 있으며, 각 석상의 눈에는 개당 200gp 가치의 루비가 박혀 있습니다.")
      .replace(/This trap activates when a ruby is pried from one of the statues\. Each statue's mouth slides open, revealing a 1-foot-wide pipe that runs down its throat\./gu, "석상 하나에서 루비를 떼어 내면 이 함정이 작동합니다. 각 석상의 입이 미끄러지듯 열리며, 목구멍 아래로 이어지는 폭 1피트의 관이 드러납니다.")
      .replace(/The longer the poison gas remains in the room, the more lethal it becomes\./gu, "독가스가 방 안에 오래 머물수록 점점 더 치명적으로 변합니다.")
      .replace(/Increased Potency\.\s*The damage from the Poison Gas element increases by 11 \((__FVTT_TOKEN_\d+__)\) each round after it activates, to a maximum of 55 \((__FVTT_TOKEN_\d+__)\)\./gu, (_, step, max) => `독성 강화. 독가스 요소의 피해는 작동한 뒤 매 라운드마다 11(${step})씩 증가하며, 최대 55(${max})까지 올라갑니다.`)
      .replace(/The rat doesn't provoke (__FVTT_TOKEN_\d+__) when it moves out of an enemy's reach\./gu, (_, opportunityAttack) => `이 쥐는 적의 손이 닿는 범위를 벗어나 이동해도 ${opportunityAttack}을 유발하지 않습니다.`)
      .replace(/This trap uses moving blades that sweep down through a chamber, threatening anyone nearby\. Typically, a scything blade trap is activated by manipulating a lever or some other simple device\. Kobolds especially like this kind of trap, since it can take down bigger creatures\./gu, "이 함정은 방 안을 휩쓸며 내려오는 움직이는 칼날을 사용해 주변의 누구든 위협합니다. 보통 낫날 함정은 지레나 그 밖의 단순한 장치를 조작하면 작동합니다. 코볼트는 이 함정을 특히 좋아하는데, 자신들보다 큰 상대도 쓰러뜨릴 수 있기 때문입니다.")
      .replace(/When the lever is pulled, the trap activates\./gu, "지레를 당기면 함정이 작동합니다.")
      .replace(/Shadrix magically summons (__FVTT_TOKEN_\d+__) (__FVTT_TOKEN_\d+__) in unoccupied spaces he can see within 60 feet of himself\. The inklings obey his commands and take their turns immediately after his\. While any of these inklings live, Shadrix has advantage on attack rolls and saving throws\. These inklings disappear after 10 minutes, when Shadrix dies, or when he uses this action again\./gu, (_, count, inklings) => `샤드릭스는 자신으로부터 60피트 이내에서 볼 수 있는 비어 있는 공간에 ${count} ${inklings}을(를) 마법으로 소환합니다. 이 잉클링들은 그의 명령에 복종하며 그의 직후에 차례를 가집니다. 이 잉클링들 가운데 하나라도 살아 있는 동안 샤드릭스는 공격 굴림과 내성 굴림에 이점을 얻습니다. 잉클링들은 10분 후, 샤드릭스가 죽을 때, 또는 그가 이 행동을 다시 사용할 때 사라집니다.`)
      .replace(/When a creature the apprentice can see within 30 feet of it fails a saving throw, the apprentice magically weaves together stirring prose, allowing the creature to reroll the saving throw and use the higher result\./gu, "견습생이 30피트 이내에서 볼 수 있는 생물이 내성 굴림에 실패하면, 견습생은 고무적인 문장을 마법으로 엮어 그 생물이 내성 굴림을 다시 굴리고 더 높은 결과를 사용하게 합니다.")
      .replace(/When a sleep of ages trap activates, a pressure plate unleashes a spell that threatens to send intruders into a deep slumber\. The dungeon's guardians can then more easily dispose of the sleepers\./gu, "영겁의 잠 함정이 작동하면 압력판이 침입자를 깊은 잠에 빠뜨릴 위협적인 주문을 방출합니다. 그 뒤 던전의 수호자들은 잠든 자들을 훨씬 쉽게 처리할 수 있습니다.")
      .replace(/Stepping on the pressure plate triggers this trap\./gu, "압력판을 밟으면 이 함정이 작동합니다.")
      .replace(/When activated, this trap casts a (__FVTT_TOKEN_\d+__) spell centered on the pressure plate, using a 9th-level spell slot\./gu, (_, sleepSpell) => `작동하면 이 함정은 압력판을 중심으로 ${sleepSpell} 주문을 9레벨 주문 슬롯으로 시전합니다.`)
